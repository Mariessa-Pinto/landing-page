...
export default function IntroCard() {
    return (
        <div className={`flex flex-col gap-5 w-full lg:w-6/12 bg-white rounded-3xl border-blue border-2 p-10`}>
            <h1 className={`font-outfit text-h1 font-bold`}>Find Your Perfect Furry Friend</h1>
